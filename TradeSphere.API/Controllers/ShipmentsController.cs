...
[RequireRole(UserRole.LogisticsOfficer, UserRole.OperationsManager, UserRole.GeneralManager)]
public sealed class ShipmentsController(ISender sender) : ApiControllerBase(sender)
{
    ...
    [RequireRole(UserRole.LogisticsOfficer, UserRole.OperationsManager)]
    [HttpPost]
