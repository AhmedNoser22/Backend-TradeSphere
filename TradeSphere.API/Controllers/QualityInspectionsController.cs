...
[RequireRole(UserRole.QualityControlOfficer, UserRole.OperationsManager, UserRole.GeneralManager,UserRole.SystemAdministrator)]
public sealed class QualityInspectionsController(ISender sender) : ApiControllerBase(sender)
{
    ...
    [RequireRole(UserRole.QualityControlOfficer, UserRole.OperationsManager, UserRole.SystemAdministrator)]
    [HttpPost]
