        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmationCodeExpiresAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    PasswordResetCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    PasswordResetCodeExpiresAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModifiedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    LastModifiedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QualityInspectionLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QualityInspectionLines_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QualityInspectionLines_QualityInspections_QualityInspectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeclaredGoodsValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CustomsDuties = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ClearanceFees = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModifiedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomsClearances_Shipments_ShipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomsClearances_ShipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QualityInspectionLines_ProductId",
                table: "QualityInspectionLines",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_QualityInspectionLines_QualityInspectionId",
                table: "QualityInspectionLines",
